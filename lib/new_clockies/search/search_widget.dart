                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            final searchTypeItems =
                                _model.searchTypes.toList().take(10).toList();
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Row(
                                ...
                                children: List.generate(searchTypeItems.length,
                                    (searchTypeItemsIndex) {
                                  final searchTypeItemsItem =
                                      searchTypeItems[searchTypeItemsIndex];
                                  return InkWell(
